...
import (
	...
	"github.com/jacksonspiedade/swaggertodo/restapi/operations"
	"github.com/jacksonspiedade/swaggertodo/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../swaggertodo --name TodoList --spec ../swagger.yml
